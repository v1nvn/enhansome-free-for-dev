...
This list results from Pull Requests, reviews, ideas, and work done by 1600+ people. You can also help by sending [Pull Requests](https://github.com/ripienaar/free-for-dev) ⭐ 117,926 | 🐛 15 | 🌐 HTML | 📅 2026-02-12 to add more services or remove ones whose offerings have changed or been retired.
...
* [Pencil](https://github.com/evolus/pencil) ⭐ 9,555 | 🐛 531 | 🌐 JavaScript | 📅 2024-09-10 - Open source design tool using Electron.
